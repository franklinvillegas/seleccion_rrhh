...
class GeneralExport implements FromArray, ShouldAutoSize, WithHeadings, WithTitle, WithEvents, Responsable
{
    use Exportable;   

    protected $rows, $columns, $extras, $titles;
    private $fileName = '';
    private $headers = [
        'Content-Type' => 'text/xlsx',
    ];

    public function __construct($array, $extras, $titles)    
    {
        $this->array = $array;
        $this->extras = $extras;
        $this->titles = $titles;
        $this->fileName = $extras['nom_archivo'].".xlsx";
    }
    ...
    {
        return $this->extras['nombre_hoja'];
    }
        ...
        return [          
            AfterSheet::class    => function(AfterSheet $event) {
               ...
               //body
                ...
                $event->sheet->setCellValue('A2',$this->extras['titulo']);
