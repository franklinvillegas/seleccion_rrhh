        ...
        <br> -->
            ...
            <div class="tab-pane fade show active" id="paso1" role="tabpanel" aria-labelledby="paso1-tab">
                <div class="row">
                    ...
                    <div class="form-group col-3">
                        ...
                        <button class="btn btn-outline-success float-left"  type="button" @click="generarLista"> Listar  </button>
                    </div>
            ...
            <template slot="table-row" slot-scope="props">
                ...
                <span v-if="props.column.field == 'asistencia'">
                    <select :disabled="true" class="form-control" v-model="props.row.estado" @change="modificarAsistencia(props.row.id,props.row.estado,props.row.razon)" > 
