    ...
    <div class="p-3">
        ...
        <br> -->
            ...
            <div class="tab-pane fade show active" id="paso1" role="tabpanel" aria-labelledby="paso1-tab">
                <div class="row">
                    ...
                    <div class="form-group col-3">
                        ...
                        <button class="btn btn-outline-success float-left"  type="button" @click="reporte"> Generar Reporte  </button>
                    </div>
            ...
            <template slot="table-row" slot-scope="props">
                ...
                {{props.row.estudiante.persona.apellido_pat}} {{props.row.estudiante.persona.apellido_mat}} {{props.row.estudiante.persona.nombres}}
                </span>
                <span v-if="props.column.field == 'nota'">
                    <span v-for="(crit,index) in criterio " :key="index" >
                            {{props.row.criterio}}
        ...
        methods:{
           ...
           listarCompetencia(id_gracur) {
            ...
            reporte(){
                ...
                this.$validator.validateAll('form_registro').then(result => {
                    if (result) {  
                        axios.post("api/notas/reporte", this.modal)
                        .then((response) => {
                            this.$toastr.s(response.data.message);
                            this.listaAlumnos.data=response.data.lista;
